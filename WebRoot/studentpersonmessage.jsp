...
<html>
  <head>
    ...
    <title>My JSP 'studentpersonmessage.jsp' starting page</title>
  ...
  <td height="50px"><%=student.getPassword() %></td>
  </tr>
  <tr>
  <td height="50px">年龄：</td>
  <td height="50px"><%=student.getAge() %></td>
  </tr>
  <tr>
  ...
  <td height="50px"><%=student.getTele() %></td>
  </tr>
  <tr>
  <td height="50px">地址：</td>
  <td height="50px"><%=student.getAddress() %></td>
  </tr>
  <tr>
